...
$0 [Freesurfer results directory] [Shape output directory] [ log dir ] [ groupfile ]
...
Afterwards, use qstat to see if all the subjects are processed. After a few hours they should be done and you can run shapeafterqsub.sh to create csv files from the shape output.
